...
if ($_POST['yrofstudy'] == -1) {
echo "<h3>Please select a valid year of study</h3>";
}
else {
$nu->displayStudentList($_POST['yrofstudy']);
$hu = true;
}
}
else if (!$hu) {
...
<h6>Select A Year Of Study</h6>
<select name="yrofstudy" class="form-control">
<option value="-1">Select A Year Of Study</option>
