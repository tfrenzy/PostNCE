...
include("Connect.php");
$nu = new Connect();
if ((isset($_SESSION['User']))&&($nu->check_lecturer($_SESSION['User']))) {
$hu = false;
if (isset($_POST['submit_'])) {
$nu->registerCourse($_SESSION['User'], $_POST['coursecode'], $_POST['coursetitle'], $_POST['yrofstudy']);
}
else if (!$hu) {
?>
<form id="contact-form" class="contact" name="contact-form" method="post" action="">
<h6>Enter Course Details</h6>
...
<option value="-1">Select Level the course is meant for</option>
