...
<title>Delete Student Information Data</title> 
...
?>
<h3>Clicking on the button below will clear all the previous information you've filled.</h3>
<?php
if (isset($_POST['submit'])) {
$nu->deleteAllSIF($_SESSION['User']);
}
else {
?>
<form id="contact-form" class="contact" name="contact-form" method="post" action="">
<button type="submit" name="submit" class="btn btn-primary">Delete All Student Information Data</button>
</form>
<?php
}
}
