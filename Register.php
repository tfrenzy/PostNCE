...
<title>Welcome to Post NCE/Sandwich Portal</title> 
...
<li class="scroll active"><a href="Register.php">Register</a></li> 
...
include("Connect.php");
$nu = new Connect();
$check = $nu->register($fullname, $phone, $matno, $email, $password, $yrofstudy);
}
else {echo "<h3>Password Mismatch</h3></br>";$check = false;}
}
else {echo "<h2>Problems with registering<br/>Check your inputs.</h2></br>";$check = false;}
}
else {echo "<h2>Please select a valid year of study</h2></br>";$check = false;}
}
else if (!$check) {
?>
...
<div class="form-group">
<input type="text" name="matricno" class="form-control" placeholder="Your Matric Number">
</div><p></p>
<div class="form-group">
...
<div class="form-group">
<input type="password" name="confirm" class="form-control" required="required" placeholder="Confirm Your Password">
</div>
<div class="form-group">
