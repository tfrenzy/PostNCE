...
$nu->checkResult($_SESSION['User'], $_POST['coursecode']);
}
else {
?>
...
<?php $nu->listMyRegisteredCourses($_SESSION['User']) ?>
</select></br>
<button type="submit" name="submit" class="btn btn-primary">Check Result</button>
<?php
}
}
